...
buyUpgrade.addEventListener('click', () => {
    if(score >= upgradeCost){
        ...
        buyUpgrade.innerText = `Купить улучшение ${upgradeCost} кг💩`

        result.innerText = `Вы купили улучшение, теперь у вас за каждое нажатие ${clickValue} `
    }
    else{
         result.innerText = `У вас недостаточно говна💩🥲 `
    }
})
